  ...
  <div class="card-body">
    ...
    <div class="order-bottom">
      <div class="order-info">
        <div class="line"><div class="line-label">收貨地址：</div><div class="line-value">{{ isset($order->address)?join(' ', $order->address):'-' }}</div></div>
      ...
      <div class="order-summary text-right">
        ...
        <div>
          ...
          <!-- 支付按鈕開始 -->
          @if(!$order->paid_at && $order->payment_method=='ecpay' && !$order->closed)
          <div class="payment-buttons">
            <a class="btn btn-primary btn-sm" href="{{ route('payment.ecpay', $order ) }}">
            付款去</a>
          </div>
          @endif
          <!-- 支付按鈕結束 -->
